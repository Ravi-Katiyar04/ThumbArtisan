...
from services.genrator import process_job, STYLE_ORDER
from services.imagekit_service import get_variant, upload_file
...
async def upload_headshot(file: UploadFile = File(...)):
    ...
    upload_url = upload_file(
        file_bytes=contents,
        file_name=file.filename or "headshot.jpeg",
        folder="headshots/",
...
async def create_job(
    ...
    # fire and forget the background processing of the job
